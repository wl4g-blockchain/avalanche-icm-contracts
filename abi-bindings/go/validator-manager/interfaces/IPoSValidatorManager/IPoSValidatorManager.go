...
func (_IPoSValidatorManager *IPoSValidatorManagerTransactor) CompleteValidatorRemoval(opts *bind.TransactOpts, validationID [32]byte, messageIndex uint32) (*types.Transaction, error) {
	return _IPoSValidatorManager.contract.Transact(opts, "completeValidatorRemoval", validationID, messageIndex)
}

// CompleteValidatorRemoval is a paid mutator transaction binding the contract method 0xd3864d73.
//
// Solidity: function completeValidatorRemoval(bytes32 validationID, uint32 messageIndex) returns(bytes32)
func (_IPoSValidatorManager *IPoSValidatorManagerSession) CompleteValidatorRemoval(validationID [32]byte, messageIndex uint32) (*types.Transaction, error) {
	return _IPoSValidatorManager.Contract.CompleteValidatorRemoval(&_IPoSValidatorManager.TransactOpts, validationID, messageIndex)
}

// CompleteValidatorRemoval is a paid mutator transaction binding the contract method 0xd3864d73.
//
// Solidity: function completeValidatorRemoval(bytes32 validationID, uint32 messageIndex) returns(bytes32)
func (_IPoSValidatorManager *IPoSValidatorManagerTransactorSession) CompleteValidatorRemoval(validationID [32]byte, messageIndex uint32) (*types.Transaction, error) {
	return _IPoSValidatorManager.Contract.CompleteValidatorRemoval(&_IPoSValidatorManager.TransactOpts, validationID, messageIndex)
}
